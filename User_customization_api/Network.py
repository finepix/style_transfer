...
base_image_path = 'images/inputs/content/ancient_city.jpg'
style_reference_image_paths = ['images/inputs/style/blue_swirls.jpg']
result_prefix = 'out_'
image_size = 400
img_size = 400
...
# if model_name == "vgg19":
#     weights = model.load_weights(TF_19_WEIGHTS_PATH_NO_TOP) #get_file('vgg19_weights_tf_dim_ordering_tf_kernels_notop.h5', TF_19_WEIGHTS_PATH_NO_TOP, cache_subdir='models')
# else:
#     weights = model.load_weights(TF_WEIGHTS_PATH_NO_TOP)#get_file('vgg16_weights_tf_dim_ordering_tf_kernels_notop.h5', TF_WEIGHTS_PATH_NO_TOP, cache_subdir='models')
#
